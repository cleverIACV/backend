...
class Profil(models.Model):
    ...
    extracted_cover_letter_data = models.JSONField(null=True, blank=True)
    final_analyse_cv_data = models.TextField(null=True, blank=True)
    final_analyse_cover_letter_data = models.TextField(null=True, blank=True)
